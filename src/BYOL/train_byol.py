...
class BYOL(nn.Module):
    def __init__(
        ...
        super().__init__()
        self.online_encoder = torchvision.models.resnet50(zero_init_residual=True)
        self.online_encoder.fc = nn.Sequential(
            nn.Linear(2048, projection_hidden_size),
        ...
        self.target_encoder = torchvision.models.resnet50(zero_init_residual=True)
    ...
    def forward(self, image_one, image_two):
        online_pred_one = self.online_predictor(self.online_encoder(image_one))
        online_pred_two = self.online_predictor(self.online_encoder(image_two))
